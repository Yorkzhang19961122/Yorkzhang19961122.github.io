...
```
得到如下结果：
![04](F:\markdown图片\2020-05-04openpose配置\04.jpg)
...
![05](F:\markdown图片\2020-05-04openpose配置\05.jpg)
...
```
![06](F:\markdown图片\2020-05-04openpose配置\06.jpg)
...
```
出现显卡信息则安装正确：
![07](F:\markdown图片\2020-05-04openpose配置\07.jpg)
### (3) 安装OpenCV
方法一：使用conda命令安装
```
...
![08](F:\markdown图片\2020-05-04openpose配置\08.jpg)
### (3) 安装swig支持
执行命令：
```
...
![09](F:\markdown图片\2020-05-04openpose配置\09.jpg)
## Step5: 运行demo
### (1) 照片的检测
...
```
运行结果为：
![10](F:\markdown图片\2020-05-04openpose配置\10.jpg)
### (2) 视频的检测
...
```
运行结果为：（按ESC键为退出）
![11](F:\markdown图片\2020-05-04openpose配置\11.jpg)
...
```
运行结果为：（按ESC键为退出）
![12](F:\markdown图片\2020-05-04openpose配置\12.jpg)
...
![13](F:\markdown图片\2020-05-04openpose配置\13.jpg)
...
![14](F:\markdown图片\2020-05-04openpose配置\14.jpg)
重新运行即可解决。
